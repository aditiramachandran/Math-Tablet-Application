...
if (CCACHE)
  ...
  set(CMAKE_CXX_COMPILER_ARG1 "${OE_CROSS}/bin/${OE_ARCH}-gcc" CACHE FILEPATH "" FORCE)
else(CCACHE)
...
set(CMAKE_CXX_FLAGS "--sysroot ${OE_STAGE}/ -I${X86_INCLUDE_DIR} -I${X86_GINCLUDE_DIR} -I${X86_CPINCLUDE_DIR} -I${X86_GCPINCLUDE_DIR} -I${X86_GPPINC_DIR} -I${X86_GPPINC2_DIR} -I${X86_GPPINC3_DIR} -I${X86_GCCINC_DIR} -march=geode" CACHE STRING "" FORCE)
